...
public class PullToRefreshRecyclerView  extends RecyclerView{
    ...
    private int TIMEOUT=300000;//刷新超时时间 如果超过这个时间还没刷新完成就会关闭刷新并提示刷新过程中出现问题
    private int DEFAULT_DURATION = 500;//底部超时上滑动画时间

    private WrapAdapter mWrapAdapter;//内部Adapter
    public RefreshHeader refreshHeader;//刷新头部
    public LoadingMoreFooter loadingMoreFooter;//加载更多底部
