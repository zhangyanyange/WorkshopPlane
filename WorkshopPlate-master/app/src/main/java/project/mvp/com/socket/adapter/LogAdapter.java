...
public class LogAdapter extends RecyclerView.Adapter<LogAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder holder, int position) {
        ...
        if(bean.mType==3){
            ...
            holder.mLog2.setVisibility(View.GONE);
        }else if(bean.mType==2){
            holder.mLog2.setVisibility(View.VISIBLE);
            holder.mLog.setVisibility(View.GONE);
        }
        holder.mTime.setText(bean.mTime);
        holder.mLog.setText(bean.mLog);
        holder.mLog2.setText(bean.mLog);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public TextView mLog2;

        public ItemHolder(View itemView) {
            super(itemView);
            mTime = (TextView) itemView.findViewById(R.id.time);
            mLog = (TextView) itemView.findViewById(R.id.logtext);
            mLog2=(TextView) itemView.findViewById(R.id.logtext2);
        }
    }
