 ...
 * 类描述
 */
public class NonScanningAdapter extends RecyclerView.Adapter<NonScanningAdapter.ViewHolder> {
    ...
    public NonScanningAdapter(Context context, List<ViewWorkConfig.DatasBean> Datas) {
        mContext = context;
        mDatasBeans = Datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(mLayoutInflater.inflate(R.layout.non_config_item, parent, false));
    }
